...
Documentação detalhada por domínio de negócio. Cada módulo inclui: domain, architecture, data-model, flows, api-reference e **usage-guide** (exemplos de uso).

- [Modules Index](../modules/README.md) — Índice de todos os módulos
- [Projects Module](../modules/projects/README.md) — Projetos M&A, taxonomia, readiness
- [Module Template](../modules/MODULE_TEMPLATE.md) — Template para criar novos módulos
